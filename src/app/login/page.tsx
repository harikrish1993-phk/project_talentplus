    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-md w-full p-8 bg-white rounded-xl shadow-2xl">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900">TalentPulse AI</h1>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-blue-800">
            ...
            No authentication required. Click below to access the dashboard.
          </p>
        </div>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>For production, configure Supabase authentication</p>
          <p className="mt-1">See <code className="text-xs bg-gray-100 px-2 py-1 rounded">COMPLETE_SETUP_GUIDE.md</code></p>
        </div>
      </div>
    </div>
  );
